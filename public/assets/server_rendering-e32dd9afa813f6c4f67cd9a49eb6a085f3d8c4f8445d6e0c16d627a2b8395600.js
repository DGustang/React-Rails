...
var Abouts = (function (_React$Component) {
    ...
    function Abouts() {
        ...
        _get(Object.getPrototypeOf(Abouts.prototype), "constructor", this).apply(this, arguments);
    }
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "collapse navbar-collapse", classID: "navbarSupportedContent" },
                        React.createElement(
                            "ul",
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { className: "nav-link dropdown-toggle", href: "#", classID: "navbarDropdown", role: "button",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { href: "/abouts", className: "card-link" },
                                    "Card link"
                                ),
                                React.createElement(
                                    "a",
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        "Common problem of templates is that all code is deeply integrated into the core. This limits your freedom in decreasing amount of code, i.e. it becomes pretty difficult to remove unnecessary code from the project. Limitless allows you to remove unnecessary and extra code easily just by removing the path to specific LESS file with component styling. All plugins and their options are also in separate files. Use only components you actually need!"
                    ),
                    React.createElement(
                        "h6",
                        { className: "text-semibold" },
                    ...
                    React.createElement(
                        "p",
                        null,
                        "You open one of the starter pages, add necessary plugins, uncomment paths to files in components.less file, compile new CSS. That's it. I'd also recommend to open one of main pages with functionality you need and copy all paths/JS code from there to your new page, it's just faster and easier."
                    )
                )
            );
        }
    ...
    _createClass(Navbar, [{
        ...
        value: function render() {
            return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement("i", { className: "icon-tree5" })
                            )
                        ),
                        React.createElement(
                            "li",
                            ...
                            React.createElement(
                                ...
                                React.createElement("i", { className: "icon-paragraph-justify3" })
                            )
                        )
                    )
                ),
                React.createElement(
                    "div",
                    { className: "navbar-collapse collapse", classID: "navbar-mobile" },
                    React.createElement(
                        "ul",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "a",
                                    { href: "#", className: "media-left" },
                                    React.createElement("img", { src: "", className: "img-circle img-sm", alt: "" })
                                ),
                                React.createElement(
                                    "div",
                                    ...
                                    React.createElement(
                                        "div",
                                        { className: "text-size-mini text-muted" },
                                        React.createElement("i", { className: "icon-pin text-size-small" }),
                                        "  Santa Ana, CA"
                                    )
                                ),
                                React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    " ",
                                    React.createElement("i", { className: "icon-menu", title: "Main pages" })
                                ),
                                React.createElement(
                                    "li",
                                    null,
